          ...
          */
          ...
          function setCropperData(){
            ...
            retValue.getCroppedImage = function(){
              ...
              if(((cropper.getBoundingClientRect().height<200)||(cropper.getBoundingClientRect().width<200))&&((divImageImg.naturalWidth > 1000)||(divImageImg.naturalHeight>1000))){
                canvas.height = cropper.getBoundingClientRect().height * ((divImageImg.naturalHeight*.6)/divImageImg.getBoundingClientRect().height);
                canvas.width = cropper.getBoundingClientRect().width * ((divImageImg.naturalWidth*.6)/divImageImg.getBoundingClientRect().width);
              }else if(((cropper.getBoundingClientRect().height<300)||(cropper.getBoundingClientRect().width<300))&&((divImageImg.naturalWidth > 1000)||(divImageImg.naturalHeight>1000))){
                canvas.height = cropper.getBoundingClientRect().height * ((divImageImg.naturalHeight*.4)/divImageImg.getBoundingClientRect().height);
                canvas.width = cropper.getBoundingClientRect().width * ((divImageImg.naturalWidth*.4)/divImageImg.getBoundingClientRect().width);
              } else {
              ...
              canvas.setAttribute('class' , 'lyteCroppedCanvas');
              ...
              if(((cropper.getBoundingClientRect().height<200)||(cropper.getBoundingClientRect().width<200))&&((divImageImg.naturalWidth > 1000)||(divImageImg.naturalHeight>1000))){
                var cx =  (divImageImg.getBoundingClientRect().left - cropper.getBoundingClientRect().left)* ((divImageImg.naturalWidth*.6)/divImageImg.getBoundingClientRect().width);
                var cy =  (divImageImg.getBoundingClientRect().top -  cropper.getBoundingClientRect().top)* ((divImageImg.naturalHeight*.6)/divImageImg.getBoundingClientRect().height);
                var cw = divImageImg.naturalWidth*.6;
                var ch = divImageImg.naturalHeight*.6;
              }else if(((cropper.getBoundingClientRect().height<300)||(cropper.getBoundingClientRect().width<300))&&((divImageImg.naturalWidth > 1000)||(divImageImg.naturalHeight>1000))){
                var cx =  (divImageImg.getBoundingClientRect().left - cropper.getBoundingClientRect().left)* ((divImageImg.naturalWidth*.4)/divImageImg.getBoundingClientRect().width);
                var cy =  (divImageImg.getBoundingClientRect().top -  cropper.getBoundingClientRect().top)* ((divImageImg.naturalHeight*.4)/divImageImg.getBoundingClientRect().height);
                var cw = divImageImg.naturalWidth*.4;
                var ch = divImageImg.naturalHeight*.4;
              } else {
              ...
              if(angle !== 0){
                ...
                if((Math.abs(angle)%90 === 0)&&(!((Math.abs(angle) === 180)||(Math.abs(angle) === 360)))){
                  if(((cropper.getBoundingClientRect().height<200)||(cropper.getBoundingClientRect().width<200))&&((divImageImg.naturalWidth > 1000)||(divImageImg.naturalHeight>1000))){
                    canvas.width = cropper.getBoundingClientRect().width * ((divImageImg.naturalHeight/divImageImg.getBoundingClientRect().width)*.6);
                    canvas.height = cropper.getBoundingClientRect().height * ((divImageImg.naturalWidth/divImageImg.getBoundingClientRect().height)*.6);
                    var cW = divImageImg.getBoundingClientRect().width * ((divImageImg.naturalHeight/divImageImg.getBoundingClientRect().width)*.6);
                    var cH = divImageImg.getBoundingClientRect().height * ((divImageImg.naturalWidth/divImageImg.getBoundingClientRect().height)*.6);
                    cx =  (divImageImg.getBoundingClientRect().left - cropper.getBoundingClientRect().left) * ((divImageImg.naturalHeight/divImageImg.getBoundingClientRect().width)*.6);
                    cy =  (divImageImg.getBoundingClientRect().top -  cropper.getBoundingClientRect().top) * ((divImageImg.naturalWidth/divImageImg.getBoundingClientRect().height)*.6);
                  } else if(((cropper.getBoundingClientRect().height<300)||(cropper.getBoundingClientRect().width<300))&&((divImageImg.naturalWidth > 1000)||(divImageImg.naturalHeight>1000))){
                    var newCanWidth = cropper.getBoundingClientRect().width * ((divImageImg.naturalHeight/divImageImg.getBoundingClientRect().width)*.4);
                    var newCanHeight = cropper.getBoundingClientRect().height * ((divImageImg.naturalWidth/divImageImg.getBoundingClientRect().height)*.4)
                    canvas.width = newCanWidth;
                    canvas.height = newCanHeight;
                    var cW = divImageImg.getBoundingClientRect().width * ((divImageImg.naturalHeight/divImageImg.getBoundingClientRect().width)*.4);
                    var cH = divImageImg.getBoundingClientRect().height * ((divImageImg.naturalWidth/divImageImg.getBoundingClientRect().height)*.4);
                    cx =  (divImageImg.getBoundingClientRect().left - cropper.getBoundingClientRect().left) * ((divImageImg.naturalHeight/divImageImg.getBoundingClientRect().width)*.4);
                    cy =  (divImageImg.getBoundingClientRect().top -  cropper.getBoundingClientRect().top) * ((divImageImg.naturalWidth/divImageImg.getBoundingClientRect().height)*.4);
                  } else {
                    canvas.width =  cropper.getBoundingClientRect().width;
                    canvas.height =  cropper.getBoundingClientRect().height;
                    var cH = divImageImg.getBoundingClientRect().height;
